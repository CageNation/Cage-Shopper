      ...
      <Responsive getWidth={getWidth} minWidth={Responsive.onlyTablet.minWidth}>
        ...
        >
          <Segment
            inverted
            textAlign="center"
            style={{height: '300px', padding: '50px 0em'}}
            vertical
          >
            <HomepageHeading />
          </Segment>
        ...
        <Grid.Row>
          <Grid.Column width={8}>
            ...
            <p style={{fontSize: '1.33em'}}>
              We can give you the best and latest Nicolas Cage Merchandise on
              the market today. We empower the Nicolas Cage fan through our
              relentless pursuit creating Nicolas Cage Merchandise
            </p>
          </Grid.Column>
